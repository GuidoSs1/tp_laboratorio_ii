...
namespace Entidades
{
    public class Comprador : Persona
    {
        ...
        public Comprador(string nombre, string apellido, long dni, EGenero genero, double billeteraUsd, ENacionalidad nacio) 
        ...
        /// <param name="genero"></param>
        /// <param name="billeteraUsd"></param>
        public Comprador(string nombre, string apellido, string dni, EGenero genero, string billeteraUsd, ENacionalidad nacio)
            : base(nombre, apellido, dni, genero, nacio)
        {
            this.BilleteraUsd = billeteraUsd;
        }
        ...
        public override string ToString()
        {
            ...
            sb.AppendFormat("\nDocumento: {0}   BTC: {1}    Billetera(USD): {2}", this.Dni, this.Btc, this.Billetera);
            return sb.ToString();
        }
