...
namespace Entidades
{
    ...
    public sealed class Taller
    {
        ...
        // Constructor por defecto inicializa la lista de vehiculos con capacidad infinita
        private Taller()
        {
            this.vehiculos = new List<Vehiculo>();
        }
        // Sobrecarga de constructor con capacidad por parametro
        ...
        /// <returns>Retorna el objeto taller con el elemento vehiculo agregado</returns>
        ...
        /// <returns>Retorna el objeto taller con el elemento vehiculo eliminado</returns>
        public static Taller operator -(Taller t, Vehiculo vehiculo)
        {
            foreach (Vehiculo v in t.vehiculos)
            {
